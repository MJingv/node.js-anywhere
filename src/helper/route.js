...
const source = fs.readFileSync(tplPath) //同步读取内容为buff(速度快)
const template = Handlebars.compile(source.toString()) //利用模版引擎编译
...
module.exports = async function(req, res, filePath, config) {
    try {
        ...
        if (stats.isFile()) {
            ...
            const dir = path.relative(config.root, filePath) //相对路径
            const data = {
